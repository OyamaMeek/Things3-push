...
## [2026-09-08 18:35] 增加简体中文使用手册

- **需求/问题描述**：
  > 再做一个使用文档。

- **实际实现的功能与改动**：
  - [操作手册]：新增首次安装、配置、前台同步、日常维护、自动推送、launchd、排障和升级说明。
  - [导航]：从简体中文 README 链接到使用手册。
  - [测试/验证]：检查文档链接、路径引用与 Git 差异格式。
...
## [2026-09-08 18:40] 更新公开仓库克隆地址

- **需求/问题描述**：
  > 将仓库地址更新为 https://github.com/OyamaMeek/Things3-push.git。

- **实际实现的功能与改动**：
  - [安装文档]：将双语 README 的 Git 克隆占位符替换为公开仓库地址。
  - [测试/验证]：确认 `origin` 的拉取与推送地址均一致。
...
- **实际实现的功能与改动**：
  - [许可证]：添加标准 MIT 许可证文本。
  - [文档]：在中英文 README 中声明许可证并链接到许可证文件。
  - [测试/验证]：检查许可证文本、README 链接与 Git 差异格式。
